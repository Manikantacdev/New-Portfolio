...
export function About() {
  ...
  const counters = [
    ...
    { icon: Timer, label: "Years Experience in MERN", value: 1 },
    ...
    <section id="about" className="about-wrapper">
        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>I'm Manikanta Gedda, a passionate full-stack developer and machine learning enthusiast dedicated to crafting innovative digital solutions that make a real-world impact.</p>
              <p>I specialize in building scalable, high-performance web applications using the MERN stack (MongoDB, Express.js, React, Node.js), combined with my expertise in Python for AI and data-driven projects.</p>
              <p>Currently pursuing B.Tech in Artificial Intelligence & Machine Learning, I love exploring the intersection of web technologies and intelligent systems — from sentiment analysis to performance prediction models.</p>
              <p>When I'm not coding, you'll find me solving problems on LeetCode, experimenting with new frameworks, or collaborating on open-source projects. I believe in continuous learning and turning complex ideas into elegant, user-friendly experiences.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`about-hobbies ${hobbiesVisible ? "hobbies-show" : "hobbies-hidden"}`}>
        ...
        <div className="hobby-grid">
          ...
          <div className="hobby">✈️ Travelling</div>
          <div className="hobby">🎮 Gaming</div>
          <div className="hobby">⚽ Team Sports</div>
          <div className="hobby">🕹️ Video Gaming</div>
        </div>
      </div>
    </section>
  );
