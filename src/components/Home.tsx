...
export function Home({ theme }: HeroProps) {
  ...
  const workLinks = [
    { img: githubLogo, link: "https://github.com/Manikantacdev" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/Manikanta_Gedda/" },
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "Full Stack Developer | Machine Learning | Data analyst";
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">Manikanta Gedda</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            { label: "📍 Location", value: "Viziznagaram, Andhra Pradesh, India" },
            { label: "💼 Expertise", value: "Full Stack, ML, Problem Solving" },
            { label: "📞 Contact", value: "manigedda731 @gmail.com" },
          ].map((info, i) => (
