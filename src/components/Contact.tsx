...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "manigedda731@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 70939xxxxx" },
    { icon: MapPin, label: "Location", value: "Vizianagaram, Andhra Pradesh, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/Manikantacdev/" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/manikanta-gedda-developer-analyst/" },
    { icon: Mail, url: "mailto:manigedda731@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+917093937645" },
    { icon: Instagram, url: "https://www.instagram.com/_manikanta_731_/" },
  ];
