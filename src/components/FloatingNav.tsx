...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Manikantacdev', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/manikanta-gedda-developer-analyst/', label: 'LinkedIn' },
    ...
    { 
      ...
      href: 'https://leetcode.com/Manikanta_Gedda/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:manigedda731@gmail.com', label: 'Email' },
  ];
